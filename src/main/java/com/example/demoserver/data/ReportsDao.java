...
public class ReportsDao {
    ...
    public  static String getItemReports(Map<String,String[]> map ) throws SQLException, IOException {
        ...
        String query = "select item_id,i.name,i.sellingPrice as itemPrice,i.createdAt, sum(quantity) as soldUnits, sum(quantity)*i.sellingPrice as totalSaleAmount, sum(ie.count) as stock " +
                "from ((select itemId as item_id, quantity, 0 as count from orders ) union all " +
